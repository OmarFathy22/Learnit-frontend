...
export default function App(props: IAppProps) {
  return (
    <div className=" flex-shrink-0 w-[320px] max-500:w-[220px]  m-2 max-900:m-1   rounded-md   ">
      <div className="bg-[--bg-primary] w-full h-full   p-5 max-400:p-3 !rounded-md ">
        <h1>
          <FaQuoteLeft className="text-[20px] max-600:text-[15px] max-400:!text-[11px]" />
        </h1>
        <h1 className="text-[20px] max-600:text-[15px] max-400:!text-[11px]">
