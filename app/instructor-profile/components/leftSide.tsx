    ...
    <div className="col-span-1  h-[100vh] sticky left-0 top-0  bottom-0 right-0 z-[100]  gradient-bg-black border-r-[1px] border-[#474747]  ">
      ...
      <ul className="mt-5 flex items-center justify-between text-center px-[50px]">
        <li>
          ...
          <h1 className="text-[--sub-text]">Students</h1>
        </li>
        <li>
          <h1 className="font-bold text-[#2EDE60]">Development</h1>
          <h1 className="text-[--sub-text]">Field</h1>
        </li>
        <li>
          <h1 className="font-bold">4</h1>
          <h1 className="text-[--sub-text]">Courses</h1>
        </li>
      </ul>
