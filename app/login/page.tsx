...
export default function App (props: IAppProps) {
  ...
  return (
    <div className='flex flex-col items-center gap-5 min-h-[calc(100vh-80px)] bg-[--bg-secondary] pt-[50px] '>
      <h1 className='gradient-text text-[20px]'>Log in to your LearnIt account</h1>
      ...
      <form className={`flex flex-col gap-3 min-w-[350px] ${ubuntu.className}`}>
        ...
        <div>
          <button onClick={(eo)=>handleSumbit(eo)} className='gradient-bg w-full py-3 rounded-sm active:scale-[.95] font-bold'>Log In</button>
        </div>
      </form>
