...
export default function App(props: IAppProps) {
  return (
    <div className="bg-[--bg-tertiary] py-[30px] pt-[100px] min-h-[100vh] pb-[150px] flex flex-col items-center gradient-t-border  ">
      {/* react slider Here */}
      <div style={{
    ...
    <div className="flex flex-col gap-3 justify-start items-center mt-[30px]  w-[70%]">
        ...
        <Link href="/become-instructor" className="gradient-bg p-2 px-[50px] rounded-md font-bold text-[18px]">Start teaching today </Link>
    </div>
    </div>
  );
}
