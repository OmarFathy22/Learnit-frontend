  ...
  return (
    <div>
      ...
      <p className="text-gray-300 text-sm">
        Create a Task Tracker application using React to apply the fundamental concepts learned in the course.
      </p>
      <ul className="list-disc ml-5 text-gray-300 text-sm">
        <li>Home Page with a welcome message and app description</li>
        <li>Task List displaying tasks with name, description, due date, and status</li>
      ...
      <p className="text-gray-300 text-sm">
        Optional (Extra Credit): Integrate with a mock API using `json-server`, and write basic tests using Jest and React Testing Library.
      </p>

      <form onSubmit={handleSubmitProject} className="w-full flex justify-between gap-3 mb-5">
        <input required type="text" placeholder="Submit Final Project URL" className="flex-1 bg-[#2D2D2D] text-white px-3 py-1 rounded-md mt-3 " />
        <button type="submit" className="gradient-bg text-white px-3 py-1 rounded-md mt-3">Submit</button>
      </form>
    </li>
      </Collapse>
        </ul>
